...
<script>
import { depGetDepartment, depGetManagerList, depAddDepartment, depGetDepartmentInfo, depEditDepartmentInfo } from '@/api/department'
export default {
  props: {
    showDialog: {
      type: Boolean,
  ...
  methods: {
    ...
    btnOk() {
      this.$refs.addDept.validate(async(isOK) => {
        if (isOK) {
          if (this.formData.id) {
            await depEditDepartmentInfo(this.formData)
